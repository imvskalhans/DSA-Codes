...
// Helper function to build a BST from sorted values.
Node* buildBST(vector<int>& sortedValues, int left, int right) {
    if (left > right) {
        return nullptr;
    }
    ...
    Node *binaryTreeToBST (Node *root)
    {
        //Your code goes here
            ...
            // Step 1: Perform in-order traversal to collect values.
    vector<int> values;
    ...
    // Step 3: Build the BST from sorted values.
    int n = values.size();
