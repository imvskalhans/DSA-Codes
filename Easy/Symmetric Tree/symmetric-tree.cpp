...
bool isSymmetricUtil(Node* leftSubtree, Node* rightSubtree) {
    ...
    // Recursively check the left subtree of the left subtree with the right subtree of the right subtree,
    // and the right subtree of the left subtree with the left subtree of the right subtree
    return isSymmetricUtil(leftSubtree->left, rightSubtree->right) &&
